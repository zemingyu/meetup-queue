...
(0, _tape2.default)('createUnsignedToken', function (t) {
    t.plan(3);

    var unsignedToken = (0, _index.createUnsignedToken)(sampleDecodedToken.header, sampleDecodedToken.payload) + '.0';
    ...
    var decodedToken = (0, _index.decodeToken)(unsignedToken);
